...
) ; extern const NeAssertData untitled_48324b08_1_assertData [ ] ; extern
const NeZCData untitled_48324b08_1_ZCData [ ] ; void
untitled_48324b08_1_computeRuntimeParameters ( const double *
runtimeRootVariables , double * runtimeParameters ) ; void
untitled_48324b08_1_validateRuntimeParameters ( const double *
runtimeParameters , int32_T * assertSatisfactionFlags ) ; void
untitled_48324b08_1_computeAsmRuntimeDerivedValues ( const double *
runtimeParameters , RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle )
; void untitled_48324b08_1_computeSimRuntimeDerivedValues ( const double *
runtimeParameters , RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle )
...
double * , const double * , const double * , double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
untitled_48324b08_1_checkDynamics ( const RuntimeDerivedValuesBundle * ,
const double * , const double * , const double * , const double * , const
double * , const int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId untitled_48324b08_1_compOutputsDyn ( const
RuntimeDerivedValuesBundle * , const int * , const double * , const int * ,
const double * , const double * , const double * , const double * , double *
, double * , int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId untitled_48324b08_1_compOutputsKin ( const
RuntimeDerivedValuesBundle * , const double * , const int * , const double *
, const double * , const double * , const double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
untitled_48324b08_1_compOutputs ( const RuntimeDerivedValuesBundle * , const
double * , const int * , const double * , const double * , const double * ,
const double * , double * , NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
untitled_48324b08_1_computeAsmModeVector ( const double * , const double * ,
const double * , int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId untitled_48324b08_1_computeSimModeVector ( const double * ,
const double * , const double * , int * , double * , NeuDiagnosticManager *
neDiagMgr ) ; PmfMessageId untitled_48324b08_1_computeZeroCrossings ( const
RuntimeDerivedValuesBundle * , const double * , const double * , const double
* , const double * , const double * , double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; void untitled_48324b08_1_setTargets (
const RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle , CTarget *
targets ) ; void untitled_48324b08_1_resetAsmStateVector ( const void * mech
, double * stateVector ) ; void untitled_48324b08_1_resetSimStateVector (
...
untitled_48324b08_1_computeDiscreteState ( const void * mech , const
RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle , double *
stateVector ) ; void untitled_48324b08_1_adjustPosition ( const void * mech ,
...
stateVector ) ; void untitled_48324b08_1_computePosDofBlendMatrix ( const
...
, double * matrix ) ; void untitled_48324b08_1_projectPartiallyTargetedPos (
...
untitled_48324b08_1_computeAssemblyError ( const void * mech , const
...
error ) ; size_t untitled_48324b08_1_computeAssemblyJacobian ( const void *
...
) ; size_t untitled_48324b08_1_computeFullAssemblyJacobian ( const void *
...
double * J ) ; boolean_T untitled_48324b08_1_isInKinematicSingularity ( const
...
void untitled_48324b08_1_convertStateVector ( const void * asmMech , const
...
untitled_48324b08_1_constructStateVector ( const void * mech , const double *
solverStateVector , const double * u , const double * uDot , const double *
discreteStateVector , double * fullStateVector ) ; void
untitled_48324b08_1_extractSolverStateVector ( const void * mech , const
...
modeVector ) ; boolean_T untitled_48324b08_1_isVelocityViolation ( const void
...
* modeVector ) ; PmfMessageId untitled_48324b08_1_projectStateSim ( const
void * mech , const RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle ,
...
untitled_48324b08_1_resetModeVector ( const void * mech , int * modeVector )
; boolean_T untitled_48324b08_1_hasJointDisToNormModeChange ( const void *
...
neDiagMgr ) ; void untitled_48324b08_1_onModeChangedCutJoints ( const void *
mech , const int * prevModeVector , const int * modeVector , double *
stateVector ) ; PmfMessageId untitled_48324b08_1_assemble ( const double * u
...
return ; untitled_48324b08_1_computeRuntimeParameters ( runtimeRootVariables
, smData -> mRuntimeParameterScalars . mX ) ;
untitled_48324b08_1_computeAsmRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
mAsmRuntimeDerivedValuesBundle ) ;
untitled_48324b08_1_computeSimRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
...
; untitled_48324b08_1_validateRuntimeParameters ( runtimeParams ,
...
untitled_48324b08_1_compDerivs ( & smData -> mSimRuntimeDerivedValuesBundle ,
smData -> mSimulationDelegate . mRunTimeEnabledEquations . mValues ,
systemInput -> mX . mX , systemInput -> mM . mX , systemInput -> mU . mX ,
systemInput -> mU . mX + 2 , systemInput -> mV . mX + 2 , systemInput -> mD .
...
errorResult = 0.0 ; errorId = untitled_48324b08_1_numJacPerturbLoBounds ( &
...
mM . mX , systemInput -> mU . mX , systemInput -> mU . mX + 2 , systemInput
-> mV . mX + 2 , systemInput -> mD . mX , daeMethodOutput -> mNUMJAC_DX_LO .
...
untitled_48324b08_1_numJacPerturbHiBounds ( & smData ->
mSimRuntimeDerivedValuesBundle , smData -> mSimulationDelegate .
mRunTimeEnabledEquations . mValues , systemInput -> mX . mX , systemInput ->
mM . mX , systemInput -> mU . mX , systemInput -> mU . mX + 2 , systemInput
-> mV . mX + 2 , systemInput -> mD . mX , daeMethodOutput -> mNUMJAC_DX_HI .
mX , & errorResult , neDiagMgr ) ; return errorId ; } static PmfMessageId
...
-> mPrivateData ; errorId = untitled_48324b08_1_compOutputs ( & smData ->
mSimRuntimeDerivedValuesBundle , systemInput -> mX . mX , systemInput -> mM .
mX , systemInput -> mU . mX , systemInput -> mU . mX + 2 , systemInput -> mV
. mX + 2 , systemInput -> mD . mX , daeMethodOutput -> mY . mX , neDiagMgr )
...
errorId = untitled_48324b08_1_computeSimModeVector ( systemInput -> mU . mX ,
systemInput -> mU . mX + 2 , systemInput -> mV . mX + 2 , daeMethodOutput ->
...
untitled_48324b08_1_computeZeroCrossings ( & smData ->
mSimRuntimeDerivedValuesBundle , systemInput -> mX . mX , systemInput -> mU .
mX , systemInput -> mU . mX + 2 , systemInput -> mV . mX + 2 , systemInput ->
...
mX , systemInput -> mU . mX + 2 , systemInput -> mD . mX , systemInput -> mX
...
untitled_48324b08_1_checkDynamics ( & smData ->
mSimRuntimeDerivedValuesBundle , systemInput -> mX . mX , systemInput -> mU .
mX , systemInput -> mU . mX + 2 , systemInput -> mV . mX + 2 , systemInput ->
...
untitled_48324b08_1_computeSimModeVector ( systemInput -> mU . mX ,
systemInput -> mU . mX + 2 , systemInput -> mV . mX + 2 , systemInput -> mM .
...
mSimulationDelegate , & smData -> mSimRuntimeDerivedValuesBundle ,
systemInput -> mU . mX , systemInput -> mU . mX + 2 , systemInput -> mD . mX
...
mSimulationDelegate , & smData -> mSimRuntimeDerivedValuesBundle ,
systemInput -> mM . mX , systemInput -> mU . mX , systemInput -> mU . mX + 2
...
size_t numTargets = 0 ; unsigned int asmStatus = 0 ; double *
...
untitled_48324b08_1_computeAsmModeVector ( systemInput -> mU . mX ,
systemInput -> mU . mX + 2 , systemInput -> mV . mX + 2 , smData ->
...
#if 0
untitled_48324b08_1_checkTargets ( & smData -> mSimRuntimeDerivedValuesBundle
...
mNumZeroCrossings = 0 ; smData -> mInputVectorSize = 2 ; smData ->
mOutputVectorSize = 1 ; smData -> mNumConstraintEqns = 0 ; for ( i = 0 ; i <
...
9 , 10 , 11 , 12 } ; const CTarget * targets = NULL ; const size_t numTargets
= 0 ; int_T status ; size_t i ; status = pm_create_real_vector_fields ( &
smData -> mAssemblyFullStateVector , 13 , alloc ) ; checkMemAllocStatus (
status ) ; status = pm_create_real_vector_fields ( & smData ->
mSimulationFullStateVector , 13 , alloc ) ; checkMemAllocStatus ( status ) ;
...
* sizeof ( int32_T ) ) ; smData -> mNumInternalTargets = 0 ; smData ->
...
untitled_48324b08_1_assertData ; size_t i ; PM_ALLOCATE_ARRAY ( smData ->
...
untitled_48324b08_1_ZCData ; size_t i ; PM_ALLOCATE_ARRAY ( smData ->
...
[ 13 ] = { "Brick_Solid1.implicit6dof1.Px.p" ,
"Brick_Solid1.implicit6dof1.Py.p" , "Brick_Solid1.implicit6dof1.Pz.p" ,
"Brick_Solid1.implicit6dof1.S.Q" , "Brick_Solid1.implicit6dof1.S.Q" ,
"Brick_Solid1.implicit6dof1.S.Q" , "Brick_Solid1.implicit6dof1.S.Q" ,
"Brick_Solid1.implicit6dof1.Px.v" , "Brick_Solid1.implicit6dof1.Py.v" ,
"Brick_Solid1.implicit6dof1.Pz.v" , "Brick_Solid1.implicit6dof1.S.w" ,
"Brick_Solid1.implicit6dof1.S.w" , "Brick_Solid1.implicit6dof1.S.w" } ; const
char * varObjects [ 13 ] = { "untitled/Brick Solid1" ,
"untitled/Brick Solid1" , "untitled/Brick Solid1" , "untitled/Brick Solid1" ,
"untitled/Brick Solid1" , "untitled/Brick Solid1" , "untitled/Brick Solid1" ,
"untitled/Brick Solid1" , "untitled/Brick Solid1" , "untitled/Brick Solid1" ,
"untitled/Brick Solid1" , "untitled/Brick Solid1" , "untitled/Brick Solid1" }
; smData -> mNumVarScalars = 13 ; smData -> mVarFullPaths = NULL ; smData ->
mVarObjects = NULL ; if ( smData -> mNumVarScalars > 0 ) { size_t s ;
PmAllocator * alloc = pm_default_allocator ( ) ; PM_ALLOCATE_ARRAY ( smData
-> mVarFullPaths , PmCharVector , 13 , alloc ) ; PM_ALLOCATE_ARRAY ( smData
-> mVarObjects , PmCharVector , 13 , alloc ) ; for ( s = 0 ; s < smData ->
...
initIoInfo ( NeDaePrivateData * smData ) { const char * inputPortPaths [ 2 ]
= { "External_Force_and_Torque.fx" , "External_Force_and_Torque.fy" } ; const
char * inputUnits [ 2 ] = { "m*kg/s^2" , "m*kg/s^2" } ; const SizePair
inputDimensions [ 2 ] = { { 1 , 1 } , { 1 , 1 } } ; const char *
outputPortPaths [ 1 ] = { "Transform_Sensor.y" } ; const char * outputUnits [
1 ] = { "m" } ; const SizePair outputDimensions [ 1 ] = { { 1 , 1 } } ;
initIoInfoHelper ( 2 , inputPortPaths , inputUnits , inputDimensions , true ,
smData ) ; initIoInfoHelper ( 1 , outputPortPaths , outputUnits ,
outputDimensions , false , smData ) ; } static void initInputDerivs (
NeDaePrivateData * smData ) { const int32_T numInputDerivs [ 2 ] = { 0 , 0 }
...
-> mNumInputDerivs . mX , numInputDerivs , 2 * sizeof ( int32_T ) ) ; smData
-> mInputOrder = 1 ; } static void initDirectFeedthrough ( NeDaePrivateData *
smData ) { const boolean_T directFeedthroughVector [ 2 ] = { false , false }
; const boolean_T directFeedthroughMatrix [ 2 ] = { false , false } ;
PmAllocator * alloc = pm_default_allocator ( ) ; { const int_T status =
pm_create_bool_vector_fields ( & smData -> mDirectFeedthroughVector , 2 ,
alloc ) ; checkMemAllocStatus ( status ) ; memcpy ( smData ->
mDirectFeedthroughVector . mX , directFeedthroughVector , 2 * sizeof (
...
pm_default_allocator ( ) ; const int32_T outputFunctionMap [ 1 ] = { 0 } ;
smData -> mOutputFunctionMap = pm_create_int_vector ( 1 , alloc ) ; memcpy (
...
jointToStageIdx = NULL ; const size_t primitiveIndices [ 1 + 1 ] = { 0 , 4 }
; const SmSizePair stateOffsets [ 4 ] = { { 0 , 7 } , { 1 , 8 } , { 2 , 9 } ,
{ 3 , 10 } } ; const SmSizePair dofOffsets [ 4 ] = { { 0 , 1 } , { 1 , 2 } ,
{ 2 , 3 } , { 3 , 6 } } ; const size_t * flexibleStages = NULL ; const size_t
* remodIndices = NULL ; const size_t * equationsPerConstraint = NULL ; const
size_t dofToVelSlot [ 6 ] = { 7 , 8 , 9 , 10 , 11 , 12 } ; const size_t *
...
sm_core_SmSizePairVector_create ( & delegate -> mJointToStageIdx , 0 , &
zeroSizePair ) ; memcpy ( sm_core_SmSizePairVector_nonConstValues ( &
delegate -> mJointToStageIdx ) , jointToStageIdx , 0 * sizeof ( SmSizePair )
...
) ; delegate -> mSetTargets = untitled_48324b08_1_setTargets ; delegate ->
mResetStateVector = untitled_48324b08_1_resetAsmStateVector ; delegate ->
mInitializeTrackedAngleState =
untitled_48324b08_1_initializeTrackedAngleState ; delegate ->
mComputeDiscreteState = untitled_48324b08_1_computeDiscreteState ; delegate
-> mAdjustPosition = untitled_48324b08_1_adjustPosition ; delegate ->
mPerturbJointPrimitiveState =
untitled_48324b08_1_perturbAsmJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState = NULL ; delegate -> mComputePosDofBlendMatrix =
untitled_48324b08_1_computePosDofBlendMatrix ; delegate ->
mComputeVelDofBlendMatrix = untitled_48324b08_1_computeVelDofBlendMatrix ;
delegate -> mProjectPartiallyTargetedPos =
untitled_48324b08_1_projectPartiallyTargetedPos ; delegate ->
mPropagateMotion = untitled_48324b08_1_propagateMotion ; delegate ->
mComputeAssemblyError = untitled_48324b08_1_computeAssemblyError ; delegate
-> mComputeAssemblyJacobian = untitled_48324b08_1_computeAssemblyJacobian ;
delegate -> mComputeFullAssemblyJacobian =
untitled_48324b08_1_computeFullAssemblyJacobian ; delegate ->
mIsInKinematicSingularity = untitled_48324b08_1_isInKinematicSingularity ;
delegate -> mConvertStateVector = untitled_48324b08_1_convertStateVector ;
...
= NULL ; const SmSizePair * jointToStageIdx = NULL ; const size_t
primitiveIndices [ 1 + 1 ] = { 0 , 4 } ; const SmSizePair stateOffsets [ 4 ]
= { { 0 , 7 } , { 1 , 8 } , { 2 , 9 } , { 3 , 10 } } ; const SmSizePair
dofOffsets [ 4 ] = { { 0 , 1 } , { 1 , 2 } , { 2 , 3 } , { 3 , 6 } } ; const
size_t * flexibleStages = NULL ; const size_t * remodIndices = NULL ; const
size_t * equationsPerConstraint = NULL ; const size_t dofToVelSlot [ 6 ] = {
7 , 8 , 9 , 10 , 11 , 12 } ; const size_t * constraintDofs = NULL ; const
size_t constraintDofOffsets [ 0 + 1 ] = { 0 } ; const size_t Jm = 0 ; const
size_t Jn = 6 ; SmSizePair zeroSizePair ; zeroSizePair . mFirst =
...
mTreeJointDof = 6 ; delegate -> mDof = 6 ; delegate -> mStateSize = 13 ;
delegate -> mContinuousStateSize = 13 ; delegate -> mModeVectorSize = 0 ;
delegate -> mNumStages = 1 ; delegate -> mNumConstraints = 0 ; delegate ->
mNumAllConstraintEquations = 0 ; sm_core_SmSizePairVector_create ( & delegate
-> mJointToStageIdx , 0 , & zeroSizePair ) ; memcpy (
sm_core_SmSizePairVector_nonConstValues ( & delegate -> mJointToStageIdx ) ,
jointToStageIdx , 0 * sizeof ( SmSizePair ) ) ; sm_core_SmSizeTVector_create
...
untitled_48324b08_1_resetSimStateVector ; delegate ->
mInitializeTrackedAngleState = NULL ; delegate -> mComputeDiscreteState =
NULL ; delegate -> mAdjustPosition = NULL ; delegate ->
mPerturbJointPrimitiveState =
untitled_48324b08_1_perturbSimJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState = untitled_48324b08_1_perturbFlexibleBodyState ;
...
delegate -> mConstructStateVector = untitled_48324b08_1_constructStateVector
; delegate -> mExtractSolverStateVector =
untitled_48324b08_1_extractSolverStateVector ; delegate ->
mIsPositionViolation = untitled_48324b08_1_isPositionViolation ; delegate ->
mIsVelocityViolation = untitled_48324b08_1_isVelocityViolation ; delegate ->
mProjectStateSim = untitled_48324b08_1_projectStateSim ; delegate ->
mComputeConstraintError = untitled_48324b08_1_computeConstraintError ;
delegate -> mResetModeVector = untitled_48324b08_1_resetModeVector ; delegate
-> mHasJointDisToNormModeChange =
untitled_48324b08_1_hasJointDisToNormModeChange ; delegate ->
mPerformJointDisToNormModeChange =
untitled_48324b08_1_performJointDisToNormModeChange ; delegate ->
mOnModeChangedCutJoints = untitled_48324b08_1_onModeChangedCutJoints ;
...
} void untitled_48324b08_1_NeDaePrivateData_create ( NeDaePrivateData *
