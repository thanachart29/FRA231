...
#endif
#include "nesl_rtw.h"
#include "untitled_48324b08_1.h"
#include "untitled_48324b08_1_gateway.h"
void untitled_48324b08_1_gateway ( void ) { NeModelParameters modelparams = {
( NeSolverType ) 0 , 0.001 , 1 , 0 , 0.001 , 0 , 0 , 0 , 0 , (
SscLoggingSetting ) 0 , 558140918 , } ; NeSolverParameters solverparams = { 0
...
sizeof ( outputparameters_init [ 0 ] ) ; } untitled_48324b08_1_dae ( & dae ,
& modelparams , & solverparams ) ; nesl_register_simulator_group (
"untitled/Solver Configuration1_1" , 1 , & dae , & solverparams , &
