...
const NeZCData * untitled_48324b08_1_ZCData = NULL ; PmfMessageId
untitled_48324b08_1_computeAsmModeVector ( const double * input , const
...
untitled_48324b08_1_computeSimModeVector ( const double * input , const
double * inputDot , const double * inputDdot , int * modeVector , double *
errorResult , NeuDiagnosticManager * neDiagMgr ) { ( void ) input ; ( void )
inputDot ; ( void ) inputDdot ; ( void ) modeVector ; ( void ) neDiagMgr ;
errorResult [ 0 ] = 0.0 ; return NULL ; } PmfMessageId
untitled_48324b08_1_computeZeroCrossings ( const RuntimeDerivedValuesBundle *
