...
typedef struct {
  ...
  real_T gt;                           /* '<S1>/Polynomial Evaluation' */
  real_T c[4];                         /* '<S1>/MATLAB Function' */
} B_test_model_T;

/* Parameters (default storage) */
struct P_test_model_T_ {
  real_T q_f1_Value;                   /* Expression: 10
                                        * Referenced by: '<S1>/q_f1'
                                        */
  real_T t_f1_Value;                   /* Expression: 7
                                        * Referenced by: '<S1>/t_f1'
                                        */
  real_T q_i1_Value;                   /* Expression: 2
                                        * Referenced by: '<S1>/q_i1'
                                        */
  real_T t_i1_Value;                   /* Expression: 3
                                        * Referenced by: '<S1>/t_i1'
                                        */
};
 ...
 *
 * '<Root>' : 'test_model'
 * '<S1>'   : 'test_model/Signal Generator'
 * '<S2>'   : 'test_model/Signal Generator/MATLAB Function'
 */
